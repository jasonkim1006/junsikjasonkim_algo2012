...
//------------------------------------------------------------
void particle::draw(){
    circleRadius = sin(ofGetElapsedTimef()*3.0);
    circleRadiusMap = ofMap(circleRadius, -1, 1, 5, 15);
    
    posYMap = ofMap(pos.y, 0, ofGetHeight(),2,20);
    ofCircle(pos.x, pos.y, circleRadiusMap);
    
    ofCircle(pos.x, pos.y, posYMap);
